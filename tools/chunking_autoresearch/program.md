...
GPU 訓練場景。這裡是本機跑、可能會被人類忘記手動中斷，所以改成**有
明確的硬性停止條件**（達到任何一個就停下來，把目前為止最好的幾個策略
整理成摘要回報給人類，不要無限跑下去）：

- **累積跑滿 500 次實驗**，或
- **累積跑滿 4 小時**（不含人類介入的時間），或
- **連續 10 次 crash**（代表可能卡在某個系統性問題上，不是策略本身的問題），或
- **連續 30 次都是 discard、沒有任何一次 keep**（代表已經找不到新方向了），或
